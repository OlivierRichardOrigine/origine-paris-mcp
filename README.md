...
Four read-only tools, the ones `tools/list` offers. The six identity tools of earlier versions are no longer listed since 0.8.0: called by name they still answer, with a deprecation notice, until 1.0.0.
